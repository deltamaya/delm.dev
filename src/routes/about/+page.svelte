...
<div class="min-h-screen flex justify-center items-center -z-10">
    <div class="flex flex-col items-center z-10">
        ...
        <div
            class="flex flex-col font-bold text-gray-900 text-4xl font-jetbrains border-8 p-4 rounded-2xl
        ...
        >
            <div class="font-bold text-gray-900 font-jetbrains flex flex-col">
                ...
                <div in:fly={{ y: 50, duration: 400, delay: 100 }}>
                    &rbrace;
                </div>
            </div>
            <div
            ...
            >
                <span style="color: hsl({scrollPosition * 720}, 80%, 50%)"
                    >maya.show()</span
                >
            </div>
        </div>
