...
>
    ...
    >
        {#each data.friends as friend, index (index)}
            <div
                class="rounded-2xl flex hover:cursor-pointer drop-shadow-2xl
            ...
            >
                <div class="h-full w-full flex flex-col justify-center">
                    <img
                        src={friend.avatar}
                        alt="avatar"
                        class="lg:w-32 md:w-20 w-16 rounded-full lg:border-4 border-2 border-white"
                    />
                    <div class="flex flex-col justify-between mt-4">
                        ...
                        <div class="flex justify-between">
                            <div
                                class="text-gray-400 lg:text-xl md:text-lg text-sm"
                            >
                                {friend.desc}
                            </div>
                            <a
                                class="font-bold lg:text-xl md:text-lg text-sm text-indigo-500 italic hover:underline"
                                href={friend.link}
                            >
                                link
                            </a>
